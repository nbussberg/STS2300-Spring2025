...
**Observations:** 113,799 observations (aka rows)
...
**Answer:** It has 243 rows (one for each player that played for both teams), and there are columns for playerID as well as number of seasons with each team. Because both data frames had a variable called Seasons, they have been renamed to Seasons.x and Seasons.y by R.
...
**How many batters played for both teams?**: 243
